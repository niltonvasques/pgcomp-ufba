    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
          \node[at=(current page.center)](img) {
            \includegraphics[width=\paperwidth]{assets/slide/scatered.jpg}
          };
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
          \node[at=(current page.center)](img) {
            \includegraphics[width=\paperwidth]{assets/slide/processing.jpg}
          };
          \node[above right,text width=14cm,align=left] at (img.south west){{\color{white}Retirado
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
          \node[at=(current page.center)](img) {
            \includegraphics[width=\paperwidth]{assets/slide/box.jpg}
          };
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
          \node[at=(current page.center)](img) {
                \includegraphics[width=\paperwidth]{assets/slide/organized.jpg}
            };
            \node[above right,text width=14cm,align=left] at (img.south
